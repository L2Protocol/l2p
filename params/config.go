...
var (
	...
	L2PChainConfig = &ChainConfig{
		...
		HertzBlock:          big.NewInt(8),
		HertzfixBlock:       big.NewInt(8),
		ShanghaiTime:        newUint64(1764597600),
		KeplerTime:          newUint64(1764597610),
		FeynmanTime:         newUint64(1764597620),
		FeynmanFixTime:      newUint64(1764597630),
		CancunTime:          newUint64(1764597640),
		HaberTime:           newUint64(1764597650),
		HaberFixTime:        newUint64(1764597660),
		BohrTime:            newUint64(1764597670),
		PascalTime:          newUint64(1764597680),
		PragueTime:          newUint64(1764597690),
		LorentzTime:         newUint64(1764597700),
		MaxwellTime:         nil,
		FermiTime:           nil,
