...
var (
	...
	L2PChainConfig = &ChainConfig{
		...
		HertzBlock:          big.NewInt(8),
		HertzfixBlock:       big.NewInt(8),
		ShanghaiTime:        newUint64(1764678600),
		KeplerTime:          newUint64(1764678610),
		FeynmanTime:         newUint64(1764678620),
		FeynmanFixTime:      newUint64(1764678630),
		CancunTime:          newUint64(1764678640),
		HaberTime:           newUint64(1764678650),
		HaberFixTime:        newUint64(1764678660),
		BohrTime:            newUint64(1764678670),
		PascalTime:          newUint64(1764678680),
		PragueTime:          newUint64(1764678690),
		LorentzTime:         newUint64(1764678700),
		MaxwellTime:         nil,
		FermiTime:           nil,
